<template>
    ...
    <view>
        <view class="page-box">
            <view class="header">
                <view class="title"> 第 {{ DcurrentPageIdx + 1 }} 页 </view>
            ...
            <view class="navi-box">
                <view class="my-button-group">
                    ...
                    >
                    <van-button
                        :disabled="DcurrentPageIdx === pages.length - 1"
                        custom-class="my-button"
                        square
                        type="primary"
                        @tap="nextPage"
...
export default {
    ...
    methods: {
        ...
        nextPage() {
            this.DcurrentPageIdx =
                this.DcurrentPageIdx + 1 >= this.pages.length ? this.pages.length - 1 : this.DcurrentPageIdx + 1;
        },
