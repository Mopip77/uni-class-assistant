...
var _topic = _interopRequireDefault(__webpack_require__(/*! ./pages/topic/topic.vue */ 131));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _topic_vue_vue_type_template_id_75f07fc5___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./topic.vue?vue&type=template&id=75f07fc5& */ 132);
/* harmony import */ var _topic_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./topic.vue?vue&type=script&lang=js& */ 134);
...
/* harmony import */ var _topic_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./topic.vue?vue&type=style&index=0&lang=scss& */ 136);
...

{
  ...
  methods: {
    ...
    getComments: function getComments() {var _this7 = this;
      ...
      promise.
      then(function (data) {var _this7$comments;
        ...
        if (_this7.offset === 0) {
          _this7.comments.splice(0);
        }
        (_this7$comments = _this7.comments).push.apply(_this7$comments, _toConsumableArray(data));
    ...
    favorite: function favorite() {var _this8 = this;
      var p = _favorite.default.favorite(_favorite.default.TOPIC_TYPE, this.topic.id);
      p.then(function (data) {
        _this8.favorited = true;
      });
    },

    unFavorite: function unFavorite() {var _this9 = this;
      var p = _favorite.default.unFavorite(_favorite.default.TOPIC_TYPE, this.topic.id);
      p.then(function (data) {
        _this9.favorited = false;
      });
    } },


  onLoad: function onLoad(option) {var _this10 = this;
    // let topicId = 4
