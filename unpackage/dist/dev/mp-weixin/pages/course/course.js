...
var _bulletin = _interopRequireDefault(__webpack_require__(/*! @/static/js/bulletin.js */ 102));
...

{
  ...
  methods: {
    ...
    loadMore: function () {var _loadMore = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _this$datas$idx;var idx, data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                console.log("获得公告", data);_context.next = 30;break;case 13:if (!(
                idx === 1)) {_context.next = 20;break;}_context.next = 16;return (

                  this.getCourseWare());case 16:data = _context.sent;
                console.log("获得课件", data);_context.next = 30;break;case 20:if (!(
                idx === 2)) {_context.next = 27;break;}_context.next = 23;return (

                  this.getContestsByCourseId());case 23:data = _context.sent;
                console.log("获得试卷", data);_context.next = 30;break;case 27:if (!(
                idx === 3)) {_context.next = 30;break;}
                // 加载课堂
                console.log("获得课堂");return _context.abrupt("return");case 30:
                ...
                this.onloadingStatuses[idx] = this.offsets[idx] === this.datas[idx].length ? "more" : "noMore";case 33:case "end":return _context.stop();}}}, _callee, this);}));function loadMore() {return _loadMore.apply(this, arguments);}return loadMore;}(),
    ...
    submitCallBack: function submitCallBack(content) {
      ...
      if (idx === 3) {
        ...
        that.$refs.lFile.upload({
          ...
          url: _api_reference.default.UPLOAD_COURSE_WARE, //测试地址，记得更换
          name: 'file',
...
var _course = _interopRequireDefault(__webpack_require__(/*! ./pages/course/course.vue */ 97));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _course_vue_vue_type_template_id_44b246f6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./course.vue?vue&type=template&id=44b246f6& */ 98);
...
/* harmony import */ var _course_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./course.vue?vue&type=style&index=0&lang=scss& */ 103);
