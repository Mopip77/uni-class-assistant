...
var _course = _interopRequireDefault(__webpack_require__(/*! ./pages/course/course.vue */ 95));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _course_vue_vue_type_template_id_44b246f6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./course.vue?vue&type=template&id=44b246f6& */ 96);
/* harmony import */ var _course_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./course.vue?vue&type=script&lang=js& */ 98);
...
/* harmony import */ var _course_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./course.vue?vue&type=style&index=0&lang=scss& */ 102);
...
var _bulletin = _interopRequireDefault(__webpack_require__(/*! @/static/js/bulletin.js */ 101));
...

{
  ...
  methods: {
    ...
    loadMore: function () {var _loadMore = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _this$datas$idx;var idx, data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                console.log("获得公告", data);_context.next = 32;break;case 13:if (!(
                idx === 1)) {_context.next = 20;break;}_context.next = 16;return (

                  this.getCourseWare());case 16:data = _context.sent;
                console.log("获得课件", data);_context.next = 32;break;case 20:if (!(
                idx === 2)) {_context.next = 27;break;}_context.next = 23;return (

                  this.getContestsByCourseId());case 23:data = _context.sent;
                console.log("获得试卷", data);_context.next = 32;break;case 27:if (!(
                idx === 3)) {_context.next = 32;break;}_context.next = 30;return (

                  this.getClass());case 30:data = _context.sent;
                console.log("获得课堂", data);case 32:
                ...
                this.onloadingStatuses[idx] = this.offsets[idx] === this.datas[idx].length ? "more" : "noMore";case 35:case "end":return _context.stop();}}}, _callee, this);}));function loadMore() {return _loadMore.apply(this, arguments);}return loadMore;}(),
      ...
      uni.showActionSheet({
        ...
        success: function success(res) {
          ...
          if (idx === 4) {
            // 通知
            uni.navigateTo({
              url: '../create_notification/create_notification?courseId=' + _this.course.id });

          } else if (idx === 3) {
            // 公告
            _this.modalTitle = '发布公告';
            _this.modalFieldName = '公告内容';
            _this.modalPlaceHolder = '请输入公告内容...';
            _this.modalSubmitText = '提交';
            ...
            // PPT课件
            _this.modalTitle = '发布课件';
            _this.modalFieldName = '课件名';
            _this.modalPlaceHolder = '请输入课件名...';
            _this.modalSubmitText = '上传文件';
            _this.showModal = true;
          } else if (idx === 0) {
            // 课堂
            uni.navigateTo({
              url: '../create_class/create_class?courseId=' + _this.course.id });
    ...
    submitCallBack: function submitCallBack(content) {
      var idx = this.newResourceIdx;
      var that = this;

      if (idx === 3) {
        // 公告
        var promise = _bulletin.default.createBulletin(that.course.id, content);
    ...
    goToClass: function goToClass(idx) {
      uni.navigateTo({
    ...
    goToCourseWare: function goToCourseWare(idx) {
      var courseWare = this.datas[1][idx];
    ...
    getContestsByCourseId: function getContestsByCourseId() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        promise.then(function (data) {
          data.forEach(function (e) {
            _utils.default.dateConverterBatch(e, false, 'publishDate', 'deadline');
          });
          resolve(data);
        });
      });
    ...
    getCourseWare: function getCourseWare() {
      ...
      var idx = this.resourceSelectIndex;
      return new Promise(function (resolve, reject) {
        var promise = _course_ware.default.getCourseWareByCourseId(
        that.course.id,
        that.offsets[idx],
        that.counts[idx]);
    ...
    getClass: function getClass() {
      ...
      return new Promise(function (resolve, reject) {
        var promise = _class.default.getClassByCourseId(that.course.id);
        promise.then(function (data) {
          data.forEach(function (e) {
            _utils.default.dateConverterBatch(e, true, 'createGmt');
          });
