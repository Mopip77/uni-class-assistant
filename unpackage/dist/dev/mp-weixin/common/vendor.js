...

{
  ...
  /**
      ...
      * @param {Number} num
      */
  dateDigitToString: function dateDigitToString(num) {
  ...
  /**
      ...
      * @param {Object} date
      */
  jsDateConverter: function jsDateConverter(date) {
    if (!date) {
      return null;
    }var _ref2 =
    ...
    this.dateDigitToString(date.getMinutes()), this.dateDigitToString(date.getSeconds())],year = _ref2[0],month = _ref2[1],day = _ref2[2],hour = _ref2[3],minute = _ref2[4],second = _ref2[5];
...
var _http_commons = _interopRequireDefault(__webpack_require__(/*! ./http_commons.js */ 18));var _getCourse$listCourse;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default = (_getCourse$listCourse = {
  ...
  joinCourse: function joinCourse(courseId, password) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _api_reference.default.JOIN_COURSE + '?courseId=' + courseId + '&password=' + password,
        method: "POST",
        header: _http_commons.default.getAuthenticationHeader(),
        success: function success(resp) {
          if (_http_commons.default.successCheck(resp)) {
...

{
  ...
  createNotifcation: function createNotifcation(courseId, title, content) {var publishGmt = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _api_reference.default.NOTIFICATION,
        method: "POST",
        header: _http_commons.default.getAuthenticationHeader(),
        data: {
          courseId: courseId,
  ...
  getNotifications: function getNotifications(offset, count) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _api_reference.default.NOTIFICATION_LIST + '?offset=' + offset + '&count=' + count,
        header: _http_commons.default.getAuthenticationHeader(),
        success: function success(resp) {
          if (_http_commons.default.successCheck(resp)) {
            resolve(resp.data.data);
  ...
  getCallbackUrl: function getCallbackUrl(notificationId) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _api_reference.default.NOTIFICATION_CALLBACK_URL + '?notificationId=' + notificationId,
        header: _http_commons.default.getAuthenticationHeader(),
        success: function success(resp) {
          if (_http_commons.default.successCheck(resp)) {
            resolve(resp.data.data);
...

{
  ...
  /**
                  ...
                  */
  exist: function exist(targetType, targetId) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _api_reference.default.FAVORITE_EXIST + '?targetType=' + targetType + '&targetId=' + targetId,
        header: _http_commons.default.getAuthenticationHeader(),
        success: function success(resp) {
          if (_http_commons.default.successCheck(resp)) {
            resolve(resp.data.data);
  ...
  /**
      ...
      * @param {Object} targetId
      */
  favorite: function favorite(targetType, targetId) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _api_reference.default.FAVORITE,
        method: "POST",
        data: {
  ...
  /**
      ...
      * @param {Object} targetId
      */
  unFavorite: function unFavorite(targetType, targetId) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _api_reference.default.FAVORITE + '?targetType=' + targetType + '&targetId=' + targetId,
        method: "DELETE",
        header: _http_commons.default.getAuthenticationHeader(),
        success: function success(resp) {
          if (_http_commons.default.successCheck(resp)) {
  ...
  /**
      ...
      * @param {Number} count
      */
  getFavoritesByType: function getFavoritesByType(targetTypes, offset, count) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _api_reference.default.FAVORITE_BY_TYPE + '?targetTypes=' + targetTypes + '&offset=' + offset + '&count=' + count,
        header: _http_commons.default.getAuthenticationHeader(),
        success: function success(resp) {
          if (_http_commons.default.successCheck(resp)) {
            resolve(resp.data.data);
...
var _http_commons = _interopRequireDefault(__webpack_require__(/*! @/static/js/http_commons.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default = _defineProperty({
  ...
  getCourseWaresAsCreator: function getCourseWaresAsCreator(offset, count) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _api_reference.default.GET_COURSE_WARE_AS_CREATOR + '?offset=' + offset + '&count=' + count,
        header: _http_commons.default.getAuthenticationHeader(),
        success: function success(resp) {
          if (_http_commons.default.successCheck(resp)) {
            resolve(resp.data.data);
  ...
  getCourseWaresAsReader: function getCourseWaresAsReader(offset, count) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _api_reference.default.GET_COURSE_WARE_AS_READER + '?offset=' + offset + '&count=' + count,
        header: _http_commons.default.getAuthenticationHeader(),
        success: function success(resp) {
          if (_http_commons.default.successCheck(resp)) {
            resolve(resp.data.data);
